  ...
  return (
    <div className='project'>
      ...
      <p className='projectText'>
        ...
        user with the most recent news updates. The following technologies were
        used to develop this application: MaterializeCSS, HTML, JavaScript,
        Chart.js, an open source COVID-19 API, and the NYT API.
      </p>
    </div>
  )
}
