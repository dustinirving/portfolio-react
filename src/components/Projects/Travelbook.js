  ...
  return (
    <div className='planner'>
      ...
      <p className='projectText'>
        ...
        account and post about their travel experiences. Other features include:
        editing and deleting posts, updating your profile, and connecting with
        nearby travellers. This project was developed with semantic UI, EJS,
