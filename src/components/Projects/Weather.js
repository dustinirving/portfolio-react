  ...
  return (
    <div className="project">
      ...
      <p className="projectText">
        This application makes use of a weather API to display the 5-day weather
        forecast for a specified location. I was tasked with developing the user
        interface in HTML and Bootstrap, while also using Javascript to fetch
